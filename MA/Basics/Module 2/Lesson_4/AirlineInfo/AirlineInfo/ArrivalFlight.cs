...
{
    class ArrivalFlight : IArrivalFlight
    {
        #region properties
        ...
        public ArrivalFlight(DateTime dateTime, string flightNumber, string cityPort, string airline, string terminal, string gate, FlightStatus flightStatus)
        {
            DateTime = dateTime;
